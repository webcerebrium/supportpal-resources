...
return array(
    ...
    "helpdesk_software"         => "Tjeneste levert av",
    ...
    "my_tickets_desc"           => "Se dine henvendelser. Du finner både aktive og tidligere henvendelser her.",
    "no_modules"                => "No modules are enabled.",
    "search_results"            => "Søkeresultater",
    "found_results"             => "Vi fant søkeresultater for dette søkeordet.",

    // Maintenance
    "maintenance"               => "Vi vedlikeholder for øyeblikket portalen.",
    "maintenance_desc"          => "Infosenteret er for øyeblikket utilgjengelig grunnet vedlikehold. Takk for tålmodigheten, vi er straks tilbake.",
    "maintenance_active"        => "Vedlikeholdsmodus er aktivert.",
