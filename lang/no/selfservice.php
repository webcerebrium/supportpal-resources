...
return array(
    ...
    "type_popular_items"        => ":type: Populære",
    "latest_items"              => "Siste Emner",
    "type_latest_items"         => ":type: Siste",
    ...
    "replying_to"               => "Svar til",
    "receive_notifications"     => "Få varsel ved fremtidige svar",
    ...
    "comment_error"             => "Kunne ikke legge til kommentar",
    "comment_success"           => "Din kommentar er lagt inn.",
    "comment_success_moderated" => "Din kommentar er lagt inn. En moderator må godkjenne den før den blir synlig.",

    "comment_rated_success"     => "The comment was successfully rated.",
    "comment_rated_error"       => "The comment could not be rated.",

    "article_find_useful"       => "Var denne artikkelen nyttig?",
    "article_found_useful"      => "personer fant denne artikkelen nyttig",
    ...
    "viewing_article"           => "Viser artikkel",
