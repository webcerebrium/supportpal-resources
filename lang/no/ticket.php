...
return array(
    ...
    "enter_your_details"        => "Kontakt oss",
    "enter_ticket_details"      => "Din melding",
    "enter_subject_message"     => "Hva trenger du hjelp til? Fyll inn relevant emne for raskere svar!",
    "invalid_user"              => "Please ensure valid user details have been entered to continue.",

    "registered_users"          => "Registered Users Only",

    "tickets"                   => "Ticket(s)",
    "ticket"                    => "Henvendelsen|Henvendelser",
    "subject"                   => "Emne",
    "no_subject"                => "No Emne",
    ...
    "track_ticket"              => "Spor Henvendelse",
    "view_ticket"               => "Se henvendelse",
    ...
    "ticket_number"             => "Henvendelse nummmer",
    ...
    "feedback_not_found"        => "Det oppsto en feil. Vennligst ta kontakt med oss.",
    "feedback_malformed_token"  => "Det oppsto en feil. Vennligst ta kontakt med oss.",
    "feedback_already_done"     => "Du har allerede gitt oss en tilbakemelding. Tusen takk!",
    ...
    "feedback_thank_you"        => "Takk for tilbakemeldingen!",
    ...
    "add_cc"                    => "Legg til kopi",
    "reply_above_line"          => "Vennligst skriv ditt svar over denne linjen.",
    ...
    "track_ticket_not_found"    => "Kunne ikke finne henvendelser med dette nummeret og e-post adresse.",
