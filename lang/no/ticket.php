...
return array(
    ...
    "enter_your_details"        => "Legg til dine detaljer",
    ...
    "enter_user_details"        => "Vennligst legg til dine detaljer nedefor for å sende oss en henvendelse. Vi bruker dette for å kontakte deg.",
