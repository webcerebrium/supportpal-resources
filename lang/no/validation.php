...
return array(
	...
	*/
    ...
    "same"                      => ":attribute og :other må være likt.",
    "size"                      => array(
    ...
    "template_exists"           => "Det valgte :attribute er ugyldig.",
    "is_valid_captcha"          => "Tegnene på bildet stemmer ikke overrens med det du har skrevet. Vennligst prøv igjen. ",
    "user_password_length"      => "Passordet må inneholde minst :user_password_length bokstaver.",
    "operator_password_length"  => "Passordet må være likt eller lenger enn :operator_password_length characters.",
     ...
     * 2.3.0
     */
    "required_translation"      => ":translation translation for the :attribute field må fylles ut.",
